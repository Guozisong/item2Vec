...
- [x] **Step 1: Write failing fetch and inference path tests**
...
- [x] **Step 3: Implement the explicit Python path contracts**
...
- [x] **Step 1: Update test helpers to create the new default layout**
...
- [x] **Step 2: Write failing custom work directory tests**
...
- [x] **Step 3: Run script tests and verify RED**
...
- [x] **Step 4: Implement minimal Bash parsing**
...
- [x] **Step 5: Run script tests and verify GREEN**
...
- [x] **Step 1: Write failing pipeline forwarding tests**
...
- [x] **Step 3: Implement pipeline option parsing and forwarding**
...
- [x] **Step 4: Run pipeline and script tests and verify GREEN**
...
- [x] **Step 1: Write the failing ignore rule assertion**
...
- [x] **Step 3: Update ignore rules and README**
